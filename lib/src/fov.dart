...
class Fov {
  ...
  Shadow _getProjection(int col, int row) {
    ...
    var rowBottomWidth = row + 1;

    // The top edge of row 0 is 2 wide.
    var rowTopWidth = row + 2;

    // Unify the bottom and top edges of the tile.
    var start = math.min(col / rowBottomWidth, col / rowTopWidth);
    var end   = math.max((col + 1) / rowBottomWidth, (col + 1) / rowTopWidth);
